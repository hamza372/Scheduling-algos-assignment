...
while jobs_remaining  != 0:
		...
		if brust_time[k]<=0:
			...
			print("job no",k,"time",time,"WT = ",time-int(arrival_time[k])-int(brust_time2[k]),"TAT = ",time-int(arrival_time[k]))
